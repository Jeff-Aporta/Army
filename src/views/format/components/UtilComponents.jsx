...
const { military_green, light_military_green, khaki } = global.identity.colors;
...
export function BotonHerramientaSecundario(props) {
  return (
    <Button
      ...
      variant="outlined"
      sx={{ mr: 1 }}
      color={isDark() ? "light_military_green" : "military_green"}
    />
  );
}
  ...
  return (
    <Typography
      ...
      sx={{
        ...
        borderColor: military_green.toBlack(0.3).hex(),
        pb: 1,
    ...
    <TextField
      ...
      InputLabelProps={{
        ...
        sx: {
          ...
          "&:focus-within": {
            color: isDark()
              ? light_military_green.main
              : military_green.main + "!important",
          },
        },
      }}
      variant="outlined"
      ...
      sx={{
        ...
        "& .MuiOutlinedInput-root": {
          "&:hover fieldset": {
            borderColor: military_green.hex(),
          },
